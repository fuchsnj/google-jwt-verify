...
const AUDIENCE: &'static str = "37772117408-qjqo9hca513pdcunumt7gk08ii6te8is.apps.googleusercontent.com";
...
#[test]
pub fn decode_keys() {
    TestKeyProvider.get_key("3f3ef9c7803cd0b8d75247ee0d31fdd5c2cf3812").unwrap();
    TestKeyProvider.get_key("a748e9f767159f667a0223318de0b2329e544362").unwrap();
}
